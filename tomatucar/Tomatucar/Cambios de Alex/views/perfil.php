...
//Para guardar foto de Perfil al momento            
   $(document).ready(function(){
...
<div class="contenedorFoto">
        ...
        <div id="formulario_usuario">
         ...
         <form enctype="multipart/form-data" role="form" class="login" id='formulario' method="post">
         	
    		<div class="form-group">
        		<label class="pull-left">Foto de Perfil:</label>
            		<input type="file" class="form-control" name="perfil" id="perfil" accept="image/jpg, image/jpeg, image/png, image/JPG, image/JPEG, image/PNG"/>
    		</div>
            ...
            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
			 ...
			 <div class="form-group">
        		<label class="pull-left">Foto de Licencia:</label>
            		<input type="file" class="form-control" name="licencia" id="licencia" accept="image/jpg, image/jpeg, image/png, image/JPG, image/JPEG, image/PNG"/>
    		</div>
        ...
        <div class="form-group" style="padding-top:33px">
      	...
      	<div class="form-group">
		  	...
		  	<input onClick="realizaProceso();" type="button" class="btn btn-primary" value="Guardar">
		</div>
