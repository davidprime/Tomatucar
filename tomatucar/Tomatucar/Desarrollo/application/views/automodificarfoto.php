...
<input name="cocheid" id="cocheid" type="text" value="<?php echo $item['IdCoche'];?>" hidden/>
       <div class="example__left4" style="padding-top:100px">
       		<?php if($item['Foto1'] > ""):?>
       			<img id="uploadPreview4" src="<?php echo base_url(); ?>uploads/<?php echo $item['Foto1']; ?>" style="width: 250px; height: 200px;">
       		<?php else: ?>
       			<img id="uploadPreview4" src="<?php echo base_url(); ?>img/ford3.jpg" style="width: 250px; height: 200px;">
       		<?php endif; ?>	
         ...
         <div class="example__left5" style="padding-top:100px">
       		<?php if($item['Foto2'] > ""):?>
       			<img id="uploadPreview5" src="<?php echo base_url(); ?>uploads/<?php echo $item['Foto2']; ?>" style="width: 250px; height: 200px;">
       		<?php else: ?>
       			<img id="uploadPreview5" src="<?php echo base_url(); ?>img/ford3.jpg" style="width: 250px; height: 200px;">
       		<?php endif; ?>
         ...
         <div class="example__left6" style="padding-top:100px">
       		<?php if($item['Foto3'] > ""):?>
       			<img id="uploadPreview6" src="<?php echo base_url(); ?>uploads/<?php echo $item['Foto3']; ?>" style="width: 250px; height: 200px;">
       		<?php else: ?>
       			<img id="uploadPreview6" src="<?php echo base_url(); ?>img/ford3.jpg" style="width: 250px; height: 200px;">
       		<?php endif; ?>
