...
<form id="precioform" name="precioform" method="post" action="<?php echo base_url(); ?>automodificarprecio/subirInformacion">
      ...
      <div id="controles_precio_auto">
        ...
        <br>
        <div  class="list-group">
        <h4 class="titulos" class="text-left"><p>Segundo dia de renta: <span id="ex5CurrentSliderValLabel"><span id="valrenta2" ><?php echo $item['CostoSegundoDiaRenta'];?></span>$ pesos</span> </p></h4>
        <div class="form-group">
        <div class="input-group">
