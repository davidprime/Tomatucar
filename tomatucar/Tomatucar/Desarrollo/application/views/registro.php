						...
						<div class="col-md-6 col-md-offset-3">
							<div class="form-group">
								<div class="input-group input-group" >
			                        ...
			                        <input type="email"  name="email" class="form-control" placeholder="ejemplo@TomatuCAR.com" tabindex="3">
								</div>
							</div>
						</div>
					</div>
...
<div class="row">
	<div class="col-md-6 col-md-offset-3">
				<div class="col-md-6">
					...
					<div id="bregistro"><button type="submit" class="btn btn-info btn-lg pull-right" tabindex="7">Registrarse</button></div>
				</form>
					<br>
					<br>
					<!-- Modal -->
