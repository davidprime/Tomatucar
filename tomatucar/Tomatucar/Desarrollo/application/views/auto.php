	...
	<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-md-3">
				         <div class="form-group">
								<div class="input-group">
								<input type="text" class="form-control" name="matricula" placeholder="Ingresa la matricula">
				...
				<div id="bradios3">
					...
					<input type="checkbox" value="1" name="espanol" id="esp" class="css-checkbox" /><label for="esp" class="css-label radGroup2">Hablo Español</label>
				...
				<br>	
				<textarea name="descripcioncoche" id="dcoche" class="form-control" rows="5" form="autoform"></textarea>
				<br>
				...
				<div id="controlradios">
					...
					<div class="row">
						<div class="col-md-3">
							<input name="renta1" id="renta1" type="text" value="0"readonly/> 
						</div>
					</div>
				<br>
				<h4 class="titulos" class="text-left"><p>Segundo dia de renta: <span id="ex5CurrentSliderValLabel"><span id="valrenta2" ></span>$ pesos</span> </p></h4>
					<div class="row">
						<div class="col-md-3">
							<input name="renta2" id="renta2" type="text" value="0" readonly/> 
						</div>
					</div>
				<div id="valor2">
				...
				<h4 class="titulos" class="text-left"><p>Precio por Km: <span id="ex6CurrentSliderValLabel"><span id="valrentakm" >0</span>$ pesos</span></p></h4>
					<div class="row">
						<div class="col-md-3">
							<input name="rentakm" id="rentakm" type="text" value="0" readonly/> 
						</div>
					</div>						
				</div>	
				<br>
