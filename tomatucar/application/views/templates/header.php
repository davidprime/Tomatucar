      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
             ...
             <?php }else{ ?>
             	<li><a href="<?php echo base_url(); ?>patrocinador">!Gana dinero ya!</a></li>
          	 	<li><a style="background:#10A6CF;" href="<?php echo base_url(); ?>beneficios">RENTAR MI VEHÍCULO</a></li> 
             <?php } ?>	
             <?php if($this->session->userdata('nombre')){?>
             	<li><a href="<?php echo base_url(); ?>patrocinador">!Gana dinero ya!</a></li>
              <li class="dropdown">
             <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $this->session->userdata('nombre')?><span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="<?php echo base_url(); ?>misRentas"><span class="glyphicon glyphicon-list-alt"></span> Mis Rentas</a></li>
             ...
             <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">¿Cómo funciona?<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="<?php echo base_url(); ?>arrendador"><span class="glyphicon glyphicon-list-alt"></span> Para arrendatario</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-wrench"></span> ¿Ayuda?</a></li> 
              </ul></li>
              <?php }else{ ?>
             <li class="dropdown">
             <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">¿Cómo funciona?<span class="caret"></span></a>
