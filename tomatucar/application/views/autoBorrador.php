...
$jq('#salvarborrador').click(function(){
     ...
     /* when the submit button in the modal is clicked, submit the form */
         /* when the submit button in the modal is clicked, submit the form */
    $jq("#autoform").attr("action", "<?php echo base_url(); ?>auto/actualizarborrador");
...
<!--INICIO DE FORM--><form id="autoform" name="autoform" method="post" action="<?php echo base_url(); ?>auto/actualizarinformacion">
				<div id="caja">
				...
				<input type="hidden" id="idcoche" name="idcoche" value="<?php echo $idCoche; ?>"><!--Se usa para saber que registro actualizar-->
				<!-- compacto-->
				...
				<div class="row">
					...
					<div class="col-md-3">
				         <div class="form-group">
								...
								<input type="text" class="form-control" name="matricula"  maxlength="10" value="<?php echo $item['Matricula']; ?>">
		...
		<div class="row">
				...
				<div id="bradios3" class="col-md-4">
					...
					<input type="checkbox" value="1" name="espanol" id="esp" class="css-checkbox" <?php if($item['Espaniol']==1){echo'checked';}?> /><label for="esp" class="css-label radGroup2">Hablo Portugues</label>
				...
				<h4 class="titulos" class="text-left"><p>A partir del segundo dia de renta: </p></h4>
					<div class="row">
						...
						<div class="col-md-3">
							<span id="ex5CurrentSliderValLabel"><span id="valrenta2" ></span>$ pesos</span> 
						</div>
						<div class="col-md-6">
