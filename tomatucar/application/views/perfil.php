 ...
 <script type="text/javascript">     
    ...
    function GuardarInfo()
    {
        $.ajax({
                ...
                processData: false,
    			contentType: false,
                url:   '<?php echo base_url(); ?>perfil/subirInformacion',
                type:  'post',
...
<form enctype="multipart/form-data" role="form" class="login" id='perfilform' method="post">
        ...
        <div class="form-group" style="padding-top:33px">
      	...
      	<div class="form-group">
		  	...
		  	<input onClick="GuardarInfo();" type="button" class="btn btn-primary" value="Guardar">
		</div>
...
<!--Testing Warning-->
<!-- Small modal -->		
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" name="info-exito" id="info-exito">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Informacion Actualizada</h4>
      </div>
      <div class="modal-body">
        <p>¡Tu informacion ha sido actualizada correctamente!</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" id="infocerrar" name="infocerrar">Cerrar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
