...
class Confirmacion extends CI_Controller{
	...
	function index($confirm){
		if($this->Confirma->confirmarEmail($confirm))
		{
			...
			$data['mensaje'] = '<div  class="alert alert-success"><strong><span class="glyphicon glyphicon-ok"></span></strong>¡FELICIDADES YA ERES PARTE DE TOMATUCAR!.<u> <a id="b13" href="'.base_url().'login" role="button">  <strong>Iniciar Sesión</strong></a></u></div>';
